...
public class AppConstants {
    ...
    public static final String FEEDBACK3 = App.getInstance().getResources().getString(R.string.sample_lorem_ipsum_small);
    public static final String FEEDBACK4 = App.getInstance().getResources().getString(R.string.sample_lorem_ipsum_small);
    public static final String FEEDBACK5 = App.getInstance().getResources().getString(R.string.sample_lorem_ipsum_small);
    public static final String FEEDBACK6 = App.getInstance().getResources().getString(R.string.sample_lorem_ipsum_small);
