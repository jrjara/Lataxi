...
public class ServiceNames {
    ...
    /*Set BASE URL here*/
    private static final String PRODUCTION_API = "http://drummondvite.com";
 
    /* Set API VERSION here*/
    public static final String API_VERSION = "/taxi/Webservices_driver";

    /*Set UPLOAD PATH. DO NOT CHANGE THIS UNLESS YOU KNOW WHAT YOU ARE DOING.*/
    public static final String PATH_UPLOADS = "/taxi/";
