...
public class BaseFragment extends Fragment {
    ...
    public void initBase(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            typeface = TypefaceCache.getInstance().getTypeface(getActivity().getApplicationContext(), "Roboto-Regular.ttf");
            typefaceBold = TypefaceCache.getInstance().getTypeface(getActivity().getApplicationContext(), "Roboto-Bold.ttf");
            typefaceItalic = TypefaceCache.getInstance().getTypeface(getActivity().getApplicationContext(), "Roboto-Italic.ttf");
            typefaceBoldItalic = TypefaceCache.getInstance().getTypeface(getActivity().getApplicationContext(), "Roboto-BoldItalic.ttf");
        } catch (Exception e) {
            e.printStackTrace();
        }
